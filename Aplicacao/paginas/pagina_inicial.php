<?php session_start(); if (isset($_SESSION["idUtilizador"])) { $idUtilizador=$_SESSION["idUtilizador"];
$nome=$_SESSION["nome"]; $tipoUtilizador=$_SESSION["tipoUtilizador"]; unset($_SESSION);
$_SESSION["idUtilizador"]=$idUtilizador; $_SESSION["nome"]=$nome; $_SESSION["tipoUtilizador"]=$tipoUtilizador; } 
?>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="filmes">
                                ...
                                <p class="filmes-titulo"><strong>American Pie: A Primeira Vez É Inesquecível
                                    </strong>
                                </p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="filmes">
                                ...
                                <p class="filmes-titulo"><strong>Harry Potter And The Deadly Hallows Part
                                        II</strong>
                                </p>
