<!-- 
    Esta página atualiza o tipo de utilizador, de "Cliente Validado" para "Cliente Apagado",
alterando o seu tipo de 3 para 5, conforme definido nas constantes de utilizador. 
...
if (isset($_SESSION["idUtilizador"])) {
    ...
    if($_SESSION["tipoUtilizador"]==ADMINISTRADOR){
        ...
        $sql = "UPDATE utilizador SET tipoUtilizador = '5' WHERE idUtilizador='$utilizador'";
